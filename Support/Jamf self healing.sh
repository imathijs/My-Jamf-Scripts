...
JAMFID=$(curl -X GET "${URL}/JSSResource/computers/serialnumber/${SERIALCOMP}" -H "accept: application/xml" -H "accept: application/json" -H "Authorization: Bearer $api_token" | xmllint --xpath '/computer/general/id' - | tr '</id>' ''​)
